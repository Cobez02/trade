...
|---|---|---|---|---|
| 1x | 17.3% | 80.2% | 124.0 | drawdown (intraday touch) |
| 2x | 17.2% | 82.8% | 43.0 | drawdown (intraday touch) |
| 3x | 16.3% | 83.7% | 24.0 | drawdown (intraday touch) |
...
Zero-edge control (same daily P&L, mean removed) on MyFundedFutures Core $50K: P(pass) = 25.4% — anything close to this number is luck, not edge.
